...
<head>
    ...
    <style>
        ...
        /* ===== PALETA (GUÍA) ===== */
        .primary { color: #DB7D35; }
        .bg-primary { background: #DB7D35; color: #ffffff; }
        .border-primary { border-color: #DB7D35; }
...
@php($cotizacion = $guia->cotizacion)
    ...
    <tr>
        ...
        <td class="doc-cell">
            <div class="doc-box">
                ...
                <div class="number">{{ $guia->numero }}</div>
                <div class="date">{{ \Carbon\Carbon::parse($guia->fecha)->format('d/m/Y') }}</div>
            </div>
        </td>
    </tr>
</table>
...
<div class="cliente">
    ...
    <strong>Lugar:</strong> {{ $cotizacion->cliente->lugar ?? '-' }}
</div>
...
<div class="small" style="margin-top:6px">
    ...
    &nbsp; | &nbsp;
    <strong>Guía generada desde cotización Nº:</strong> {{ $cotizacion->numero }}
</div>

{{-- ================= ITEMS (igual que cotización) ================= --}}
<table>
    <thead>
    <tr>
...
{{-- ================= OBS + TOTAL (igual que cotización) ================= --}}
<table class="totales">
    <tr>
        <td style="width:60%">
